...
namespace Helper.UIHelper
{
    public static class RsaKeys
    {
        ...
        /// <returns></returns>
        public static RSACryptoServiceProvider ImportPrivateKey(this RSACryptoServiceProvider csp, string pem)
        {
        ...
        /// <param name="pem"></param>
        /// <returns></returns>
        public static RSACryptoServiceProvider ImportPublicKey(this RSACryptoServiceProvider csp, string pem)
        {
            var pr = new PemReader(new StringReader(pem));
