...
namespace Helper.UIHelper
{
    public sealed class DotNetUtilities
    {
        ...
        //public static Org.BouncyCastle.X509.X509Certificate ToX509Certificate(
        //    System.Security.Cryptography.X509Certificates.X509Certificate x509Cert)
        //{
        //    return new Org.BouncyCastle.X509.X509Certificate(x509Cert.GetEncoded());
        //}

        public static Org.BouncyCastle.X509.X509Certificate FromX509Certificate(
            System.Security.Cryptography.X509Certificates.X509Certificate x509Cert)
        {
